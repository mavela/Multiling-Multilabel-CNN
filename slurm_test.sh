...
#SBATCH -o /scratch/project_2002026/cnn/multiling-cnn/pretty/slurm-log/bert-%j.out
#SBATCH -e /scratch/project_2002026/cnn/multiling-cnn/pretty/slurm-log/bert-%j.err
